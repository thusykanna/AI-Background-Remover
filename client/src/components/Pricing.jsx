          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {plans.map((plan) => (
              <div
                ...
                className={
                  plan.popular
                    ? 'relative pt-6 pb-6 backdrop-blur-lg rounded-2xl border-gray-800 rounded-xl hover:transform hover:-translate-y-2 transition-all duration-300'
                    : 'relative pt-6 pb-6 border-gray-800 rounded-xl hover:transform hover:-translate-y-2 transition-all duration-300'
                }
              >
                {plan.popular && (
